...
{
	{"data/BGM/BGM.wav",     -1, 0.2f},	// BGM0
	{"data/BGM/GameBGM.wav", -1, 0.5f},	// BGM1
	{"data/SE/GameOver.wav",  0, 0.2f},	// BGM2(ゲームオーバー音(ピー)
	{"data/SE/発射音.wav",    0, 0.2f},	// 弾発射音
	{"data/SE/Beam.wav",      0, 0.2f},	// ビーム発射音
	{"data/SE/ヒット.wav",    0, 0.2f},	// ヒット音
	{"data/SE/爆発音.wav",    0, 0.2f},	// 爆発音
	{"data/SE/Reflect.wav",   0, 0.2f}, // 跳ね返し音
	{"data/SE/決定音.wav",    0, 0.5f}, // 決定音
};
